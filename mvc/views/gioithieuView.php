...
<body class="wrapper">
  ...
  <section class="section_content">
    ...
    <section class="section_content--2">
      <div class="container">
        <div class="box_content--2">
          <div class="row">
            <div class="col">
              <div class="box-img">
                <img src="./public/images/bg/bg_content_2-1.png" alt="">
              </div>
            </div>
            <div class="col">
    ...
    <section class="section_content--3">
      <div class="container">
        ...
        <!-- sản phẩm 1 -->
        <section class="san_pham san_pham--1">
          <div class="row">
            <div class="col-md-7">
              <div class="box-text--inf">
                <h1>
            ...
            <div class="col-md-5">
              <div class="box_img">
                <img src="./public/images/bg/bg_sp--1.png" alt="">
              </div>
            </div>
          </div>
        </section>
        ...
        <!-- sản phẩm 2 -->
        <section class="san_pham san_pham--2">
          <div class="row">
            <div class="col-md-5">
              <div class="box_img">
                <img src="./public/images/bg/bg_sp--2.png" alt="">
              </div>
            </div>
        ...
        <!-- sản phẩm 3 -->
        <section class="san_pham san_pham--3">
          <div class="row">
            <div class="col-md-7">
              <div class="box-text--inf">
                <h1>
            ...
            <div class="col-md-5">
              <div class="box_img">
                <img src="./public/images/bg/bg_sp--3.png" alt="">
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="san_pham san_pham--2">
          <div class="row">
            <div class="col-md-5">
              <div class="box_img">
                <img src="./public/images/bg/bg_sp--4.png" alt="">
              </div>
            </div>
            ...
            <div class="col-md-7">
              <div class="box-text--inf">
                <h1>
                  Bật/tắt Bình nóng lạnh, đèn sưởi nhà tắm
                </h1>
                <p>
        ...
        <section class="san_pham san_pham--3">
          <div class="row">
            ...
            <div class="col-md-5">
              <div class="box_img">
                <img src="./public/images/bg/bg_sp--5.png" alt="">
              </div>
            </div>
          </div>
        </section>
